...
namespace Clutter {
	...
	public struct FrameListenerIface {
		public weak Clutter.FrameListenerBeforeFrameFunc before_frame;
		public weak Clutter.FrameListenerFrameFunc frame;
	}
#endif
	[CCode (cheader_filename = "clutter/clutter.h", has_type_id = false)]
...
#if HAS_MUTTER338
	[CCode (cheader_filename = "clutter/clutter.h", instance_pos = 2.9)]
	public delegate void FrameListenerBeforeFrameFunc (Clutter.FrameClock frame_clock, int64 frame_count);
	[CCode (cheader_filename = "clutter/clutter.h", instance_pos = 3.9)]
	public delegate Clutter.FrameResult FrameListenerFrameFunc (Clutter.FrameClock frame_clock, int64 frame_count, int64 time_us);
#endif
	[CCode (cheader_filename = "clutter/clutter.h", instance_pos = 1.9)]
	[Version (since = "1.0")]
